/**
 * Component Job10DisplayareaComponent is defined as
 * `<e-job10-displayarea-component>`
 *
 * Imperatively create component
 * @example
 * let component = new Job10DisplayareaComponent();
 *
 * Declaratively create component
 * @example
 * <e-job10-displayarea-component></e-job10-displayarea-component>
 *
 * @extends {LitComponent}
 */
import { definition } from '@eui/component';
import { LitComponent, html } from '@eui/lit-component';
import style from './job10DisplayareaComponent.css';
import '@eui/table';
import '@eui/layout';
import '@eui/base';
 ...
 */
@definition('e-job10-displayarea-component', {
  style,
  home: 'job10-displayarea-component',
  props: {
    propOne: { attribute: true, type: Boolean },
    propTwo: { attribute: true, type: String, default: 'Hello World' },
  },
})
export default class Job10DisplayareaComponent extends LitComponent {
  doGraph(jsonData) {
    const json = jsonData;
...
/**
 * Register the component as e-job10-displayarea-component.
 * Registration can be done at a later time and with a different name
 */
Job10DisplayareaComponent.register();
