/**
 * Component Job3MainComponent is defined as
 * `<e-job3-main-component>`
 *
 * Imperatively create component
 * @example
 * let component = new Job3MainComponent();
 *
 * Declaratively create component
 * @example
 * <e-job3-main-component></e-job3-main-component>
 *
 * @extends {LitComponent}
 */
import { definition } from '@eui/component';
import { LitComponent, html } from '@eui/lit-component';
import style from './job3MainComponent.css';
import '@eui/layout';
import '@eui/table';
import '@eui/base';
/**
 ...
 */
@definition('e-job3-main-component', {
  style,
  home: 'job3-main-component',
  props: {
    propOne: { attribute: true, type: Boolean },
    propTwo: { attribute: true, type: String, default: 'Hello World' },
  },
})
export default class Job3MainComponent extends LitComponent {
