/**
 * Component Job2DisplayareaComponent is defined as
 * `<e-job2-displayarea-component>`
 *
 * Imperatively create component
 * @example
 * let component = new Job2DisplayareaComponent();
 *
 * Declaratively create component
 * @example
 * <e-job2-displayarea-component></e-job2-displayarea-component>
 *
 * @extends {LitComponent}
 */
import { definition } from '@eui/component';
import { LitComponent, html } from '@eui/lit-component';
import style from './job2DisplayareaComponent.css';
import '@eui/table';
import '@eui/layout';
import '@eui/base';
 ...
 */
@definition('e-job2-displayarea-component', {
  style,
  home: 'job2-displayarea-component',
  props: {
...
export default class Job2DisplayareaComponent extends LitComponent {
  ...
  async _makeData(){
    ...
    while (localloop < localto) {
      ...
      let answer = new Promise((res, rej) => {
        fetch('http://localhost:8080/build-recovery-time-v2/job/127/time-period', {
          method: 'POST',
          body: jsonobj,
      ...
      answer = new Promise((res, rej) => {
        fetch('http://localhost:8080/build-failure-rate/job/127/time-period', {
          method: 'POST',
          body: jsonobj,
          headers: { 'Content-Type': 'application/json' }
        }).then(res => res.json())
  ...
  async loadNames() {
    fetch('http://localhost:8080/build-failure-rate/job/127')
  ...
  async loadStats(){
    fetch('http://localhost:8080/build-recovery-time-v2/job/127')
      .then(function (response) {
        return response.json();
      })
      .then(function (data) {
...
Job2DisplayareaComponent.register();
