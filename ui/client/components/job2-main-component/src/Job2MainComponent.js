/**
 * Component Job2MainComponent is defined as
 * `<e-job2-main-component>`
 *
 * Imperatively create component
 * @example
 * let component = new Job2MainComponent();
 *
 * Declaratively create component
 * @example
 * <e-job2-main-component></e-job2-main-component>
 *
 * @extends {LitComponent}
 */
import { definition } from '@eui/component';
import { LitComponent, html } from '@eui/lit-component';
import style from './job2MainComponent.css';
 ...
 */
@definition('e-job2-main-component', {
  style,
  home: 'job2-main-component',
  props: {
    propOne: { attribute: true, type: Boolean },
    propTwo: { attribute: true, type: String, default: 'Hello World' },
  },
})
export default class Job2MainComponent extends LitComponent {
